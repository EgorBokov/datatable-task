import type { PageType, PricesType, ProductType } from '@utils/types/mockDataTypes.ts';
...
export const pagesData: Array<PageType> = [
    {
        "id": 13334466,
...
export const pricesData: Array<PricesType> = [
    {
        "id": 23634610,
